<template>
  <div class="region-set panel-container">
    ...
    <div class="region-set-table panel">
...
export default {
  ...
  methods: {
    ...
    getCleaningList() {
      let res = CommonFun.regionSetData;
      let labelList = [
        { label: "区域名称", prop: "regionName" },
        { label: "区域类型", prop: "regionType" },
        { label: "执行方式", prop: "executeMethod" },
        { label: "区域性质", prop: "regionNature" },
        { label: "负责人", prop: "principal" },
        { label: "登记日期", prop: "startTime" },
