<template>
  <div class="batch-stockIn panel-container">
    ...
    <div class="batch-stockIn-table panel">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getCleaningList() {
        let res = CommonFun.batchStockInData;
        let labelList = [
          { label: "申请编号", prop: "applicationNumber" },
          { label: "申请名称", prop: "applicationName" },
          { label: "物品来源", prop: "goodsSource" },
          { label: "申请人", prop: "applicant" },
          { label: "经办人", prop: "handlePeople" },
          { label: "入库日期", prop: "stockInTime" },
